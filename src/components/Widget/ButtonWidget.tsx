...
const ButtonWidget = () => {
    ...
    return (
        <div className='w-screen h-screen relative cursor-pointer'  >
            <div className='bg-gray-400 hover:scale-105 lg:w-auto w-[50px] h-[50px] lg:h-auto lg:p-4 rounded-full absolute right-12 bottom-[50px] flexCenterCenter gap-4' onClick={()=>setOpen(!open)}>
